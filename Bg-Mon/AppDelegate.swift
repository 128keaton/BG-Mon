...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.bittank.Bg_Mon" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Bg_Mon", withExtension: "momd")!
...
extension AppDelegate: WCSessionDelegate {
    ...
    func session(session: WCSession, didReceiveMessage message: [String : AnyObject], replyHandler: ([String : AnyObject]) -> Void) {
        if message["type"] as! String == "request" {
            ...
            if objectAlreadyExist("meals") {
                ...
                meals.addObject(message["data"] as! NSMutableDictionary)
    ...
    func objectAlreadyExist(key: String) -> Bool {
        return NSUserDefaults(suiteName: "group.com.128keaton.test-strip")!.objectForKey(key) != nil
    }
